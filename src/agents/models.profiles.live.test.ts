...
async function ensureLiveProviderApisRegistered(params: {
  ...
  // model probes still need the real Ollama transport registered in-process.
  const { createConfiguredOllamaStreamFn } = await import("../../extensions/ollama/runtime-api.js");
